...
namespace RelayZero.Tests.EditMode.Architecture
{
    public sealed class UnityAssemblyBoundaryTests
    {
        private static readonly Dictionary<string, string[]> ExpectedRuntimeReferences = new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            ["RelayZero.Simulation"] = new[] { "RelayZero.Foundation", "RelayZero.Arena" },
            ["RelayZero.Simulation.Authoring"] = new[] { "RelayZero.Simulation" },
            ...
            ["RelayZero.Client.Presentation"] = new[]
            {
                "RelayZero.Foundation",
                "RelayZero.Arena",
                "RelayZero.Arena.Baking",
                "RelayZero.Simulation",
                "RelayZero.Simulation.Authoring",
